      ...
      <div className="grid-collapse-1" style={{
        ...
        <section style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {[
              { href: '/content/new', label: '+ New Content', primary: true },
              { href: '/users', label: 'Manage Users', primary: false },
              { href: '/requests', label: 'Content Requests', primary: false },
              { href: '/analytics/platform', label: 'Platform Analytics', primary: false },
              { href: '/analytics/growth', label: 'Growth Analytics', primary: false },
              { href: '/support', label: 'Support Queue', primary: false },
            ].map(item => (
