  ...
  return (
    <div className="admin-page">
      <div className="admin-page-header">
        ...
        <Link href="/initiatives/product-lab/new" className="btn-primary">+ New edition</Link>
      </div>
          ...
          <tbody>
            {(editions ?? []).map(ed => (
              <tr key={ed.id}>
                ...
                <td>
                  <Link href={`/initiatives/product-lab/${ed.id}`} className="btn-ghost" style={{ padding: '0.25rem 0.625rem', fontSize: '0.8125rem' }}>
                    Edit
                  </Link>
                </td>
              </tr>
            ...
            {(!editions || editions.length === 0) && (
              <tr>
                <td colSpan={6} style={{ textAlign: 'center', color: '#9ca3af', padding: '2rem' }}>
                  No editions yet. <Link href="/initiatives/product-lab/new" style={{ color: '#6366f1' }}>Create one →</Link>
                </td>
              </tr>
            )}
          </tbody>
