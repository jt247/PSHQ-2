...
// Shared mobile nav trigger for the public header, dashboard sidebar, and
// admin sidebar. Toggles a class on <body> rather than owning the sidebar
// markup itself, since the sidebar in each layout is a server-rendered
// sibling — CSS (see globals.css `.mobile-nav-*` rules) reacts to the class.
