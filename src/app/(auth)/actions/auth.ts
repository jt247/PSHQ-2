...
export async function signUpAction(
  ...
  // We persist first_name / last_name via the trigger's raw_user_meta_data.
  // The user lands here — show a "check your email" confirmation screen.
...
export async function signInAction(
  ...
  // Check if onboarding is complete (shouldn't be needed for email signups
  // but handles edge cases where the user skipped it somehow).
