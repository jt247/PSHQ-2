// Auto-derived from supabase/migrations — regenerate with:
// npx supabase gen types typescript --linked > packages/database/src/index.ts
// (then re-add this header comment, the generator overwrites the file)
